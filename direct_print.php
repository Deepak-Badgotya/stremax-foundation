...
<head>
    ...
    <title>Registration/Candidate Request Form</title>
</head>
    ...
    <main>
        <div class="container">
            ...
            <div class="row justify-center">
                <p class="text-center">Registration/Candidate Request Form</p>
            ...
            <div class="">
                ...
                <ol>
                    <li lang="hi">
                        ...
                        टीम आपसे सम्पर्क करेगी।
                    </li>
                    <li lang="hi">
                        बिना संस्थान अफिलिएशन के आपका फॉर्म सबमिट नहीं हो पायेगा। इसलिए आप यह रजिस्ट्रेशन रसीद
                        अपने
                        प्रिंसिपल/टीचर को दिखाएं, और उनके साथ चर्चा करें और हमारे दिए गए नंबर पर उनसे बात करने को बोले
                        या
                        बात कराएं।
                    </li>
                </ol>
